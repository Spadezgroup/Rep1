...
$.fn.bic_calendar = function(options) {
    ...
    this.each(function() {
        ...
        function showCalendar() {
            ...
            var nextYearButton = $('<td><a href="#" class="button-year-next"><i class="fa fa-angle-right" ></i></a></td>');
            //event
            ...
            var previousYearButton = $('<td><a href="#" class="button-year-previous"><i class="fa fa-angle-left" ></i></a></td>');
            //event
